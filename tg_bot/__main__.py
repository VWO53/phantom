...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="Connect Group❗️", callback_data="main_connect"),InlineKeyboardButton(text="Add Me🔶",url="t.me/{}?startgroup=true".format(bot.username))]]
